...
{
    P03_OPENDRAIN_MODE;          /* External pull high resister in circuit */
    P04_OPENDRAIN_MODE;          /* External pull high resister in circuit */
    set_P0S_3;                   /* Setting schmit tigger mode */
    set_P0S_4;                   /* Setting schmit tigger mode */
